...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { end_time: @availability.end_time, start_time: @availability.start_time, teacher_id: @availability.teacher_id }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { end_time: @availability.end_time, start_time: @availability.start_time, teacher_id: @availability.teacher_id }
    assert_redirected_to availability_path(assigns(:availability))
  end
